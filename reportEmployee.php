    ...
    <head>
		...
		<script type="text/javascript" src="./js/controller.js"></script>
                ...
                <script type="text/javascript">
                    $(document).ready(
                        function(){                                                       
                            $('#dlgEmpleados').dialog('open').dialog('setTitle', "Reporte de Clientes");
                            $('#fm').form('clear');
                        }
                    );
                </script>
			...
			<div id="contenedor">
				<?php include_once("./view/menu.html"); ?>
                                ...
                                <div style="height:600px;">
                                    ...
                                    <div id="dlgEmpleados" class="easyui-dialog" style="width:300px;height:180px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
                                    ...
                                    <div id="dlg-buttons">
                                        <a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-search" onclick="openReportPDF('./controller/c_employee.php?action=report');" style="width:90px">Consultar</a>
